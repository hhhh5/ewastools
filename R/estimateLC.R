...
#' @param ref Choice of reference dataset: available options are `gervin` [2], `reinius` [3], `goede` [4], `bakulski` [5], `lolipop` [6],  or specific combinations of them. Current default is `bakulski+goede`.
