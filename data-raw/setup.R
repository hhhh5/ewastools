setwd("/media/Jdrive/PM/Just_Lab/projects/ewastools_releases/")
...
manifest_epic = fread('data-raw/MethylationEPIC_v-1-0_B3.csv'
...
controls_epic = fread('data-raw/MethylationEPIC_v-1-0_B3.csv',skip=865927,header=FALSE)
...
manifest_450K = fread('data-raw/HumanMethylation450_15017482_v1-2.csv'
...
controls_450K = fread('data-raw/HumanMethylation450_15017482_v1-2.csv',skip=485586,header=FALSE)
